...
export const AnimatedMenuIcon: React.FC<IconProps> = ({ className }) => {
  const { x } = useDrawer();
  const progress = useTransform(x, [0, DRAWER_WIDTH], [0, 1]);

  // Top bar of menu -> Top of chevron
  const dTop = useTransform(
    progress,
    [0, 1],
    ["M 4 6 L 20 6", "M 14 6 L 6 12"]
  );

  // Bottom bar of menu -> Bottom of chevron
  const dBottom = useTransform(
    progress,
    [0, 1],
    ["M 4 18 L 20 18", "M 14 18 L 6 12"]
  );

  // Opacity for the middle bar
  const middleOpacity = useTransform(progress, [0, 0.5], [1, 0]);
  ...
  return (
    <svg
      ...
      className={className}
    >
      <motion.path strokeLinecap="round" strokeLinejoin="round" d={dTop} />
      <motion.path strokeLinecap="round" strokeLinejoin="round" d="M 4 12 L 20 12" style={{ opacity: middleOpacity }} />
      <motion.path strokeLinecap="round" strokeLinejoin="round" d={dBottom} />
    </svg>
  );
};
...
export const GlobeAltIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c.507 0 1.006-.024 1.49-.071M12 21c-.507 0-1.006-.024-1.49-.071M3.284 14.251A9.009 9.009 0 0012 21.003A9.009 9.009 0 0020.716 14.251M3.284 14.251L1.86 9.75M20.716 14.251L22.14 9.75m0 0a9.008 9.008 0 00-9.284-11.248M3.284 14.251A9.008 9.008 0 0112 3.003a9.008 9.008 0 018.716 11.248M3.284 14.251c-.12-.341-.232-.69-.333-1.047M20.716 14.251c.12-.341.232-.69.333-1.047M12 3.003v.004m0-4.008v4.004" />
    </svg>
);
...
export const PaintBrushIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.475 2.118S3.542 15.5 2.25 14.252a2.25 2.25 0 012.118-2.475 3 3 0 001.128-5.78 2.25 2.25 0 012.475-2.118c2.536 1.291 4.252 3.542 4.252 3.542a3 3 0 005.78-1.128 2.25 2.25 0 012.475-2.118c1.291 2.536 3.542 4.252 3.542 4.252a3 3 0 00-1.128 5.78 2.25 2.25 0 01-2.118 2.475c-2.536-1.291-4.252-3.542-4.252-3.542a3 3 0 00-5.78 1.128z" />
    </svg>
);

export const CogIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12a7.5 7.5 0 0015 0m-15 0a7.5 7.5 0 1115 0m-15 0H3m16.5 0H21m-1.5 0H12m0 0h3.75m-3.75 0a7.5 7.5 0 01-7.5 0m7.5 0v3.75m-3.75-3.75a7.5 7.5 0 017.5 0m-7.5 0v-3.75" />
    </svg>
);
